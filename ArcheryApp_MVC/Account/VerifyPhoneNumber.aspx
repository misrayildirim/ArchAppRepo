<%@ Page Title="Telefon Numarasını Doğrula" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="VerifyPhoneNumber.aspx.cs" Inherits="ArcheryApp_MVC.Account.VerifyPhoneNumber" %>
